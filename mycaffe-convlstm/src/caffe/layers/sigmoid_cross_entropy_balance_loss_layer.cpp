...
#include "caffe/layers/sigmoid_cross_entropy_balance_loss_layer.hpp"
#include "caffe/util/math_functions.hpp"

namespace caffe {

template <typename Dtype>
void SigmoidCrossEntropyBalanceLossLayer<Dtype>::LayerSetUp(
...
template <typename Dtype>
void SigmoidCrossEntropyBalanceLossLayer<Dtype>::Reshape(
    const vector<Blob<Dtype>*>& bottom, const vector<Blob<Dtype>*>& top) {
...
template <typename Dtype>
void SigmoidCrossEntropyBalanceLossLayer<Dtype>::Forward_cpu(
    const vector<Blob<Dtype>*>& bottom, const vector<Blob<Dtype>*>& top) {
...
template <typename Dtype>
void SigmoidCrossEntropyBalanceLossLayer<Dtype>::Backward_cpu(
...
#ifdef CPU_ONLY
STUB_GPU_BACKWARD(SigmoidCrossEntropyBalanceLossLayer, Backward);
#endif

INSTANTIATE_CLASS(SigmoidCrossEntropyBalanceLossLayer);
REGISTER_LAYER_CLASS(SigmoidCrossEntropyBalanceLoss);
