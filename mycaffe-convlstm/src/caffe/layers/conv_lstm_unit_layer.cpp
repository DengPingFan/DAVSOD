...
template <typename Dtype>
void ConvLSTMUnitLayer<Dtype>::Reshape(const vector<Blob<Dtype>*>& bottom,
...
template <typename Dtype>
void ConvLSTMUnitLayer<Dtype>::Forward_cpu(const vector<Blob<Dtype>*>& bottom,
    const vector<Blob<Dtype>*>& top) {
...
template <typename Dtype>
void ConvLSTMUnitLayer<Dtype>::Backward_cpu(const vector<Blob<Dtype>*>& top,
...
#ifdef CPU_ONLY
STUB_GPU(ConvLSTMUnitLayer);
#endif

INSTANTIATE_CLASS(ConvLSTMUnitLayer);
REGISTER_LAYER_CLASS(ConvLSTMUnit);
