...
_sym_db.RegisterEnumDescriptor(_LSTMCONVOLUTIONPARAMETER_ENGINE)
...
_LAYERPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='interp_param', full_name='caffe.LayerParameter.interp_param', index=35,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='lstm_conv_param', full_name='caffe.LayerParameter.lstm_conv_param', index=60,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='lstm_debug_param', full_name='caffe.LayerParameter.lstm_debug_param', index=61,
...
LSTMDebugParameter = _reflection.GeneratedProtocolMessageType('LSTMDebugParameter', (_message.Message,), dict(
  DESCRIPTOR = _LSTMDEBUGPARAMETER,
  __module__ = 'caffe.proto.caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.LSTMDebugParameter)
  ))
_sym_db.RegisterMessage(LSTMDebugParameter)

LSTMConvolutionParameter = _reflection.GeneratedProtocolMessageType('LSTMConvolutionParameter', (_message.Message,), dict(
  DESCRIPTOR = _LSTMCONVOLUTIONPARAMETER,
  __module__ = 'caffe.proto.caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.LSTMConvolutionParameter)
  ))
_sym_db.RegisterMessage(LSTMConvolutionParameter)
