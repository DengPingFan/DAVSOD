...
class LSTMDebugParameter;
class LSTMConvolutionParameter;
...
enum LSTMConvolutionParameter_Engine {
  LSTMConvolutionParameter_Engine_DEFAULT = 0,
  LSTMConvolutionParameter_Engine_CAFFE = 1,
  LSTMConvolutionParameter_Engine_CUDNN = 2
};
bool LSTMConvolutionParameter_Engine_IsValid(int value);
const LSTMConvolutionParameter_Engine LSTMConvolutionParameter_Engine_Engine_MIN = LSTMConvolutionParameter_Engine_DEFAULT;
const LSTMConvolutionParameter_Engine LSTMConvolutionParameter_Engine_Engine_MAX = LSTMConvolutionParameter_Engine_CUDNN;
const int LSTMConvolutionParameter_Engine_Engine_ARRAYSIZE = LSTMConvolutionParameter_Engine_Engine_MAX + 1;

const ::google::protobuf::EnumDescriptor* LSTMConvolutionParameter_Engine_descriptor();
inline const ::std::string& LSTMConvolutionParameter_Engine_Name(LSTMConvolutionParameter_Engine value) {
  return ::google::protobuf::internal::NameOfEnum(
    LSTMConvolutionParameter_Engine_descriptor(), value);
}
inline bool LSTMConvolutionParameter_Engine_Parse(
    const ::std::string& name, LSTMConvolutionParameter_Engine* value) {
  return ::google::protobuf::internal::ParseNamedEnum<LSTMConvolutionParameter_Engine>(
    LSTMConvolutionParameter_Engine_descriptor(), name, value);
}
enum Phase {
  TRAIN = 0,
  TEST = 1
...
class LayerParameter : public ::google::protobuf::Message {
 public:
  ...
  // optional .caffe.BNParameter bn_param = 147;
  inline bool has_bn_param() const;
  inline void clear_bn_param();
  static const int kBnParamFieldNumber = 147;
  ...
  // optional .caffe.InterpParameter interp_param = 148;
  inline bool has_interp_param() const;
  inline void clear_interp_param();
  static const int kInterpParamFieldNumber = 148;
  ...
  // repeated .caffe.LSTMConvolutionParameter lstm_conv_param = 150;
  inline int lstm_conv_param_size() const;
  inline void clear_lstm_conv_param();
  static const int kLstmConvParamFieldNumber = 150;
  inline const ::caffe::LSTMConvolutionParameter& lstm_conv_param(int index) const;
  inline ::caffe::LSTMConvolutionParameter* mutable_lstm_conv_param(int index);
  inline ::caffe::LSTMConvolutionParameter* add_lstm_conv_param();
  inline const ::google::protobuf::RepeatedPtrField< ::caffe::LSTMConvolutionParameter >&
      lstm_conv_param() const;
  inline ::google::protobuf::RepeatedPtrField< ::caffe::LSTMConvolutionParameter >*
      mutable_lstm_conv_param();

  // optional .caffe.LSTMDebugParameter lstm_debug_param = 151;
  inline bool has_lstm_debug_param() const;
  inline void clear_lstm_debug_param();
  static const int kLstmDebugParamFieldNumber = 151;
  inline const ::caffe::LSTMDebugParameter& lstm_debug_param() const;
  inline ::caffe::LSTMDebugParameter* mutable_lstm_debug_param();
  inline ::caffe::LSTMDebugParameter* release_lstm_debug_param();
  inline void set_allocated_lstm_debug_param(::caffe::LSTMDebugParameter* lstm_debug_param);
 ...
 private:
  ...
  inline void set_has_lstm_debug_param();
  inline void clear_has_lstm_debug_param();
  ...
  ::google::protobuf::RepeatedPtrField< ::caffe::LSTMConvolutionParameter > lstm_conv_param_;
  ::caffe::LSTMDebugParameter* lstm_debug_param_;
  int phase_;
  mutable int _cached_size_;
  friend void  protobuf_AddDesc_caffe_2eproto();
  friend void protobuf_AssignDesc_caffe_2eproto();
...
class InterpParameter : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_zoom_factor() const;
  inline void clear_zoom_factor();
  static const int kZoomFactorFieldNumber = 3;
  inline ::google::protobuf::int32 zoom_factor() const;
  inline void set_zoom_factor(::google::protobuf::int32 value);

  // optional int32 shrink_factor = 4 [default = 1];
  inline bool has_shrink_factor() const;
  inline void clear_shrink_factor();
  static const int kShrinkFactorFieldNumber = 4;
  inline ::google::protobuf::int32 shrink_factor() const;
  inline void set_shrink_factor(::google::protobuf::int32 value);
  ...
  inline ::google::protobuf::int32 pad_beg() const;
  inline void set_pad_beg(::google::protobuf::int32 value);
  ...
  inline ::google::protobuf::int32 pad_end() const;
  inline void set_pad_end(::google::protobuf::int32 value);
...
class LSTMDebugParameter : public ::google::protobuf::Message {
 public:
  LSTMDebugParameter();
  virtual ~LSTMDebugParameter();

  LSTMDebugParameter(const LSTMDebugParameter& from);

  inline LSTMDebugParameter& operator=(const LSTMDebugParameter& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const LSTMDebugParameter& default_instance();

  void Swap(LSTMDebugParameter* other);

  // implements Message ----------------------------------------------

  LSTMDebugParameter* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const LSTMDebugParameter& from);
  void MergeFrom(const LSTMDebugParameter& from);
  void Clear();
  bool IsInitialized() const;
  ...
  inline int expose_size() const;
  inline void clear_expose();
  static const int kExposeFieldNumber = 1;
  inline const ::std::string& expose(int index) const;
  inline ::std::string* mutable_expose(int index);
  inline void set_expose(int index, const ::std::string& value);
  inline void set_expose(int index, const char* value);
  inline void set_expose(int index, const char* value, size_t size);
  inline ::std::string* add_expose();
  inline void add_expose(const ::std::string& value);
  inline void add_expose(const char* value);
  inline void add_expose(const char* value, size_t size);
  inline const ::google::protobuf::RepeatedPtrField< ::std::string>& expose() const;
  inline ::google::protobuf::RepeatedPtrField< ::std::string>* mutable_expose();

  // optional bool disable_hadamard = 2;
  inline bool has_disable_hadamard() const;
  inline void clear_disable_hadamard();
  static const int kDisableHadamardFieldNumber = 2;
  inline bool disable_hadamard() const;
  inline void set_disable_hadamard(bool value);

  // optional uint32 axis_hadamard = 3 [default = 3];
  inline bool has_axis_hadamard() const;
  inline void clear_axis_hadamard();
  static const int kAxisHadamardFieldNumber = 3;
  inline ::google::protobuf::uint32 axis_hadamard() const;
  inline void set_axis_hadamard(::google::protobuf::uint32 value);

  // optional uint32 num_axes_hadamard = 4 [default = 2];
  inline bool has_num_axes_hadamard() const;
  inline void clear_num_axes_hadamard();
  static const int kNumAxesHadamardFieldNumber = 4;
  inline ::google::protobuf::uint32 num_axes_hadamard() const;
  inline void set_num_axes_hadamard(::google::protobuf::uint32 value);

  // optional bool ignore_x = 5 [default = false];
  inline bool has_ignore_x() const;
  inline void clear_ignore_x();
  static const int kIgnoreXFieldNumber = 5;
  inline bool ignore_x() const;
  inline void set_ignore_x(bool value);

  // @@protoc_insertion_point(class_scope:caffe.LSTMDebugParameter)
 private:
  inline void set_has_disable_hadamard();
  inline void clear_has_disable_hadamard();
  inline void set_has_axis_hadamard();
  inline void clear_has_axis_hadamard();
  inline void set_has_num_axes_hadamard();
  inline void clear_has_num_axes_hadamard();
  inline void set_has_ignore_x();
  inline void clear_has_ignore_x();

  ::google::protobuf::UnknownFieldSet _unknown_fields_;

  ::google::protobuf::uint32 _has_bits_[1];
  mutable int _cached_size_;
  ::google::protobuf::RepeatedPtrField< ::std::string> expose_;
  ::google::protobuf::uint32 axis_hadamard_;
  bool disable_hadamard_;
  bool ignore_x_;
  ::google::protobuf::uint32 num_axes_hadamard_;
  friend void  protobuf_AddDesc_caffe_2eproto();
  friend void protobuf_AssignDesc_caffe_2eproto();
  friend void protobuf_ShutdownFile_caffe_2eproto();

  void InitAsDefaultInstance();
  static LSTMDebugParameter* default_instance_;
};
// -------------------------------------------------------------------

class LSTMConvolutionParameter : public ::google::protobuf::Message {
 public:
  LSTMConvolutionParameter();
  virtual ~LSTMConvolutionParameter();

  LSTMConvolutionParameter(const LSTMConvolutionParameter& from);

  inline LSTMConvolutionParameter& operator=(const LSTMConvolutionParameter& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const LSTMConvolutionParameter& default_instance();

  void Swap(LSTMConvolutionParameter* other);

  // implements Message ----------------------------------------------

  LSTMConvolutionParameter* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const LSTMConvolutionParameter& from);
  void MergeFrom(const LSTMConvolutionParameter& from);
  void Clear();
  bool IsInitialized() const;
  ...
  typedef LSTMConvolutionParameter_Engine Engine;
  static const Engine DEFAULT = LSTMConvolutionParameter_Engine_DEFAULT;
  static const Engine CAFFE = LSTMConvolutionParameter_Engine_CAFFE;
  static const Engine CUDNN = LSTMConvolutionParameter_Engine_CUDNN;
  static inline bool Engine_IsValid(int value) {
    return LSTMConvolutionParameter_Engine_IsValid(value);
  }
  static const Engine Engine_MIN =
    LSTMConvolutionParameter_Engine_Engine_MIN;
  static const Engine Engine_MAX =
    LSTMConvolutionParameter_Engine_Engine_MAX;
  static const int Engine_ARRAYSIZE =
    LSTMConvolutionParameter_Engine_Engine_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor*
  Engine_descriptor() {
    return LSTMConvolutionParameter_Engine_descriptor();
  }
  static inline const ::std::string& Engine_Name(Engine value) {
    return LSTMConvolutionParameter_Engine_Name(value);
  }
  static inline bool Engine_Parse(const ::std::string& name,
      Engine* value) {
    return LSTMConvolutionParameter_Engine_Parse(name, value);
  }
  ...
  // optional .caffe.LSTMConvolutionParameter.Engine engine = 15 [default = DEFAULT];
  inline bool has_engine() const;
  inline void clear_engine();
  static const int kEngineFieldNumber = 15;
  inline ::caffe::LSTMConvolutionParameter_Engine engine() const;
  inline void set_engine(::caffe::LSTMConvolutionParameter_Engine value);
  ...
  // optional string type = 19 [default = "all"];
  inline bool has_type() const;
  inline void clear_type();
 ...
 private:
  ...
  void InitAsDefaultInstance();
  static LSTMConvolutionParameter* default_instance_;
};
// ===================================================================
...
// repeated .caffe.LSTMConvolutionParameter lstm_conv_param = 150;
inline int LayerParameter::lstm_conv_param_size() const {
  return lstm_conv_param_.size();
}
inline void LayerParameter::clear_lstm_conv_param() {
  lstm_conv_param_.Clear();
}
inline const ::caffe::LSTMConvolutionParameter& LayerParameter::lstm_conv_param(int index) const {
  // @@protoc_insertion_point(field_get:caffe.LayerParameter.lstm_conv_param)
  return lstm_conv_param_.Get(index);
}
inline ::caffe::LSTMConvolutionParameter* LayerParameter::mutable_lstm_conv_param(int index) {
  // @@protoc_insertion_point(field_mutable:caffe.LayerParameter.lstm_conv_param)
  return lstm_conv_param_.Mutable(index);
}
inline ::caffe::LSTMConvolutionParameter* LayerParameter::add_lstm_conv_param() {
  // @@protoc_insertion_point(field_add:caffe.LayerParameter.lstm_conv_param)
  return lstm_conv_param_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::caffe::LSTMConvolutionParameter >&
LayerParameter::lstm_conv_param() const {
  // @@protoc_insertion_point(field_list:caffe.LayerParameter.lstm_conv_param)
  return lstm_conv_param_;
}
inline ::google::protobuf::RepeatedPtrField< ::caffe::LSTMConvolutionParameter >*
LayerParameter::mutable_lstm_conv_param() {
  // @@protoc_insertion_point(field_mutable_list:caffe.LayerParameter.lstm_conv_param)
  return &lstm_conv_param_;
}

// optional .caffe.LSTMDebugParameter lstm_debug_param = 151;
inline bool LayerParameter::has_lstm_debug_param() const {
  return (_has_bits_[1] & 0x20000000u) != 0;
}
inline void LayerParameter::set_has_lstm_debug_param() {
  _has_bits_[1] |= 0x20000000u;
}
inline void LayerParameter::clear_has_lstm_debug_param() {
  _has_bits_[1] &= ~0x20000000u;
}
inline void LayerParameter::clear_lstm_debug_param() {
  if (lstm_debug_param_ != NULL) lstm_debug_param_->::caffe::LSTMDebugParameter::Clear();
  clear_has_lstm_debug_param();
}
inline const ::caffe::LSTMDebugParameter& LayerParameter::lstm_debug_param() const {
  // @@protoc_insertion_point(field_get:caffe.LayerParameter.lstm_debug_param)
  return lstm_debug_param_ != NULL ? *lstm_debug_param_ : *default_instance_->lstm_debug_param_;
}
inline ::caffe::LSTMDebugParameter* LayerParameter::mutable_lstm_debug_param() {
  set_has_lstm_debug_param();
  if (lstm_debug_param_ == NULL) lstm_debug_param_ = new ::caffe::LSTMDebugParameter;
  // @@protoc_insertion_point(field_mutable:caffe.LayerParameter.lstm_debug_param)
  return lstm_debug_param_;
}
inline ::caffe::LSTMDebugParameter* LayerParameter::release_lstm_debug_param() {
  clear_has_lstm_debug_param();
  ::caffe::LSTMDebugParameter* temp = lstm_debug_param_;
  lstm_debug_param_ = NULL;
  return temp;
}
inline void LayerParameter::set_allocated_lstm_debug_param(::caffe::LSTMDebugParameter* lstm_debug_param) {
  delete lstm_debug_param_;
  lstm_debug_param_ = lstm_debug_param;
  if (lstm_debug_param) {
    set_has_lstm_debug_param();
  } else {
    clear_has_lstm_debug_param();
  }
  // @@protoc_insertion_point(field_set_allocated:caffe.LayerParameter.lstm_debug_param)
}
...
// repeated string expose = 1;
inline int LSTMDebugParameter::expose_size() const {
  return expose_.size();
}
inline void LSTMDebugParameter::clear_expose() {
  expose_.Clear();
}
inline const ::std::string& LSTMDebugParameter::expose(int index) const {
  // @@protoc_insertion_point(field_get:caffe.LSTMDebugParameter.expose)
  return expose_.Get(index);
}
inline ::std::string* LSTMDebugParameter::mutable_expose(int index) {
  // @@protoc_insertion_point(field_mutable:caffe.LSTMDebugParameter.expose)
  return expose_.Mutable(index);
}
inline void LSTMDebugParameter::set_expose(int index, const ::std::string& value) {
  // @@protoc_insertion_point(field_set:caffe.LSTMDebugParameter.expose)
  expose_.Mutable(index)->assign(value);
}
inline void LSTMDebugParameter::set_expose(int index, const char* value) {
  expose_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:caffe.LSTMDebugParameter.expose)
}
inline void LSTMDebugParameter::set_expose(int index, const char* value, size_t size) {
  expose_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:caffe.LSTMDebugParameter.expose)
}
inline ::std::string* LSTMDebugParameter::add_expose() {
  return expose_.Add();
}
inline void LSTMDebugParameter::add_expose(const ::std::string& value) {
  expose_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:caffe.LSTMDebugParameter.expose)
}
inline void LSTMDebugParameter::add_expose(const char* value) {
  expose_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:caffe.LSTMDebugParameter.expose)
}
inline void LSTMDebugParameter::add_expose(const char* value, size_t size) {
  expose_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:caffe.LSTMDebugParameter.expose)
}
inline const ::google::protobuf::RepeatedPtrField< ::std::string>&
LSTMDebugParameter::expose() const {
  // @@protoc_insertion_point(field_list:caffe.LSTMDebugParameter.expose)
  return expose_;
}
inline ::google::protobuf::RepeatedPtrField< ::std::string>*
LSTMDebugParameter::mutable_expose() {
  // @@protoc_insertion_point(field_mutable_list:caffe.LSTMDebugParameter.expose)
  return &expose_;
}

// optional bool disable_hadamard = 2;
inline bool LSTMDebugParameter::has_disable_hadamard() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void LSTMDebugParameter::set_has_disable_hadamard() {
  _has_bits_[0] |= 0x00000002u;
}
inline void LSTMDebugParameter::clear_has_disable_hadamard() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void LSTMDebugParameter::clear_disable_hadamard() {
  disable_hadamard_ = false;
  clear_has_disable_hadamard();
}
inline bool LSTMDebugParameter::disable_hadamard() const {
  // @@protoc_insertion_point(field_get:caffe.LSTMDebugParameter.disable_hadamard)
  return disable_hadamard_;
}
inline void LSTMDebugParameter::set_disable_hadamard(bool value) {
  set_has_disable_hadamard();
  disable_hadamard_ = value;
  // @@protoc_insertion_point(field_set:caffe.LSTMDebugParameter.disable_hadamard)
}

// optional uint32 axis_hadamard = 3 [default = 3];
inline bool LSTMDebugParameter::has_axis_hadamard() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void LSTMDebugParameter::set_has_axis_hadamard() {
  _has_bits_[0] |= 0x00000004u;
}
inline void LSTMDebugParameter::clear_has_axis_hadamard() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void LSTMDebugParameter::clear_axis_hadamard() {
  axis_hadamard_ = 3u;
  clear_has_axis_hadamard();
}
inline ::google::protobuf::uint32 LSTMDebugParameter::axis_hadamard() const {
  // @@protoc_insertion_point(field_get:caffe.LSTMDebugParameter.axis_hadamard)
  return axis_hadamard_;
}
inline void LSTMDebugParameter::set_axis_hadamard(::google::protobuf::uint32 value) {
  set_has_axis_hadamard();
  axis_hadamard_ = value;
  // @@protoc_insertion_point(field_set:caffe.LSTMDebugParameter.axis_hadamard)
}

// optional uint32 num_axes_hadamard = 4 [default = 2];
inline bool LSTMDebugParameter::has_num_axes_hadamard() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void LSTMDebugParameter::set_has_num_axes_hadamard() {
  _has_bits_[0] |= 0x00000008u;
}
inline void LSTMDebugParameter::clear_has_num_axes_hadamard() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void LSTMDebugParameter::clear_num_axes_hadamard() {
  num_axes_hadamard_ = 2u;
  clear_has_num_axes_hadamard();
}
inline ::google::protobuf::uint32 LSTMDebugParameter::num_axes_hadamard() const {
  // @@protoc_insertion_point(field_get:caffe.LSTMDebugParameter.num_axes_hadamard)
  return num_axes_hadamard_;
}
inline void LSTMDebugParameter::set_num_axes_hadamard(::google::protobuf::uint32 value) {
  set_has_num_axes_hadamard();
  num_axes_hadamard_ = value;
  // @@protoc_insertion_point(field_set:caffe.LSTMDebugParameter.num_axes_hadamard)
}

// optional bool ignore_x = 5 [default = false];
inline bool LSTMDebugParameter::has_ignore_x() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void LSTMDebugParameter::set_has_ignore_x() {
  _has_bits_[0] |= 0x00000010u;
}
inline void LSTMDebugParameter::clear_has_ignore_x() {
  _has_bits_[0] &= ~0x00000010u;
}
inline void LSTMDebugParameter::clear_ignore_x() {
  ignore_x_ = false;
  clear_has_ignore_x();
}
inline bool LSTMDebugParameter::ignore_x() const {
  // @@protoc_insertion_point(field_get:caffe.LSTMDebugParameter.ignore_x)
  return ignore_x_;
}
inline void LSTMDebugParameter::set_ignore_x(bool value) {
  set_has_ignore_x();
  ignore_x_ = value;
  // @@protoc_insertion_point(field_set:caffe.LSTMDebugParameter.ignore_x)
}
...
// optional uint32 num_output = 1;
inline bool LSTMConvolutionParameter::has_num_output() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void LSTMConvolutionParameter::set_has_num_output() {
  _has_bits_[0] |= 0x00000001u;
}
inline void LSTMConvolutionParameter::clear_has_num_output() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void LSTMConvolutionParameter::clear_num_output() {
  num_output_ = 0u;
  clear_has_num_output();
}
inline ::google::protobuf::uint32 LSTMConvolutionParameter::num_output() const {
  // @@protoc_insertion_point(field_get:caffe.LSTMConvolutionParameter.num_output)
  return num_output_;
}
inline void LSTMConvolutionParameter::set_num_output(::google::protobuf::uint32 value) {
  set_has_num_output();
  num_output_ = value;
  // @@protoc_insertion_point(field_set:caffe.LSTMConvolutionParameter.num_output)
}

// optional bool bias_term = 2 [default = true];
inline bool LSTMConvolutionParameter::has_bias_term() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void LSTMConvolutionParameter::set_has_bias_term() {
  _has_bits_[0] |= 0x00000002u;
}
inline void LSTMConvolutionParameter::clear_has_bias_term() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void LSTMConvolutionParameter::clear_bias_term() {
  bias_term_ = true;
  clear_has_bias_term();
}
inline bool LSTMConvolutionParameter::bias_term() const {
  // @@protoc_insertion_point(field_get:caffe.LSTMConvolutionParameter.bias_term)
  return bias_term_;
}
inline void LSTMConvolutionParameter::set_bias_term(bool value) {
  set_has_bias_term();
  bias_term_ = value;
  // @@protoc_insertion_point(field_set:caffe.LSTMConvolutionParameter.bias_term)
}

// repeated uint32 pad = 3;
inline int LSTMConvolutionParameter::pad_size() const {
  return pad_.size();
}
inline void LSTMConvolutionParameter::clear_pad() {
  pad_.Clear();
}
inline ::google::protobuf::uint32 LSTMConvolutionParameter::pad(int index) const {
  // @@protoc_insertion_point(field_get:caffe.LSTMConvolutionParameter.pad)
  return pad_.Get(index);
}
inline void LSTMConvolutionParameter::set_pad(int index, ::google::protobuf::uint32 value) {
  pad_.Set(index, value);
  // @@protoc_insertion_point(field_set:caffe.LSTMConvolutionParameter.pad)
}
inline void LSTMConvolutionParameter::add_pad(::google::protobuf::uint32 value) {
  pad_.Add(value);
  // @@protoc_insertion_point(field_add:caffe.LSTMConvolutionParameter.pad)
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >&
LSTMConvolutionParameter::pad() const {
  // @@protoc_insertion_point(field_list:caffe.LSTMConvolutionParameter.pad)
  return pad_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >*
LSTMConvolutionParameter::mutable_pad() {
  // @@protoc_insertion_point(field_mutable_list:caffe.LSTMConvolutionParameter.pad)
  return &pad_;
}

// repeated uint32 kernel_size = 4;
inline int LSTMConvolutionParameter::kernel_size_size() const {
  return kernel_size_.size();
}
inline void LSTMConvolutionParameter::clear_kernel_size() {
  kernel_size_.Clear();
}
inline ::google::protobuf::uint32 LSTMConvolutionParameter::kernel_size(int index) const {
  // @@protoc_insertion_point(field_get:caffe.LSTMConvolutionParameter.kernel_size)
  return kernel_size_.Get(index);
}
inline void LSTMConvolutionParameter::set_kernel_size(int index, ::google::protobuf::uint32 value) {
  kernel_size_.Set(index, value);
  // @@protoc_insertion_point(field_set:caffe.LSTMConvolutionParameter.kernel_size)
}
inline void LSTMConvolutionParameter::add_kernel_size(::google::protobuf::uint32 value) {
  kernel_size_.Add(value);
  // @@protoc_insertion_point(field_add:caffe.LSTMConvolutionParameter.kernel_size)
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >&
LSTMConvolutionParameter::kernel_size() const {
  // @@protoc_insertion_point(field_list:caffe.LSTMConvolutionParameter.kernel_size)
  return kernel_size_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >*
LSTMConvolutionParameter::mutable_kernel_size() {
  // @@protoc_insertion_point(field_mutable_list:caffe.LSTMConvolutionParameter.kernel_size)
  return &kernel_size_;
}

// repeated uint32 stride = 6;
inline int LSTMConvolutionParameter::stride_size() const {
  return stride_.size();
}
inline void LSTMConvolutionParameter::clear_stride() {
  stride_.Clear();
}
inline ::google::protobuf::uint32 LSTMConvolutionParameter::stride(int index) const {
  // @@protoc_insertion_point(field_get:caffe.LSTMConvolutionParameter.stride)
  return stride_.Get(index);
}
inline void LSTMConvolutionParameter::set_stride(int index, ::google::protobuf::uint32 value) {
  stride_.Set(index, value);
  // @@protoc_insertion_point(field_set:caffe.LSTMConvolutionParameter.stride)
}
inline void LSTMConvolutionParameter::add_stride(::google::protobuf::uint32 value) {
  stride_.Add(value);
  // @@protoc_insertion_point(field_add:caffe.LSTMConvolutionParameter.stride)
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >&
LSTMConvolutionParameter::stride() const {
  // @@protoc_insertion_point(field_list:caffe.LSTMConvolutionParameter.stride)
  return stride_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >*
LSTMConvolutionParameter::mutable_stride() {
  // @@protoc_insertion_point(field_mutable_list:caffe.LSTMConvolutionParameter.stride)
  return &stride_;
}

// repeated uint32 dilation = 18;
inline int LSTMConvolutionParameter::dilation_size() const {
  return dilation_.size();
}
inline void LSTMConvolutionParameter::clear_dilation() {
  dilation_.Clear();
}
inline ::google::protobuf::uint32 LSTMConvolutionParameter::dilation(int index) const {
  // @@protoc_insertion_point(field_get:caffe.LSTMConvolutionParameter.dilation)
  return dilation_.Get(index);
}
inline void LSTMConvolutionParameter::set_dilation(int index, ::google::protobuf::uint32 value) {
  dilation_.Set(index, value);
  // @@protoc_insertion_point(field_set:caffe.LSTMConvolutionParameter.dilation)
}
inline void LSTMConvolutionParameter::add_dilation(::google::protobuf::uint32 value) {
  dilation_.Add(value);
  // @@protoc_insertion_point(field_add:caffe.LSTMConvolutionParameter.dilation)
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >&
LSTMConvolutionParameter::dilation() const {
  // @@protoc_insertion_point(field_list:caffe.LSTMConvolutionParameter.dilation)
  return dilation_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >*
LSTMConvolutionParameter::mutable_dilation() {
  // @@protoc_insertion_point(field_mutable_list:caffe.LSTMConvolutionParameter.dilation)
  return &dilation_;
}

// optional uint32 pad_h = 9 [default = 0];
inline bool LSTMConvolutionParameter::has_pad_h() const {
  return (_has_bits_[0] & 0x00000040u) != 0;
}
inline void LSTMConvolutionParameter::set_has_pad_h() {
  _has_bits_[0] |= 0x00000040u;
}
inline void LSTMConvolutionParameter::clear_has_pad_h() {
  _has_bits_[0] &= ~0x00000040u;
}
inline void LSTMConvolutionParameter::clear_pad_h() {
  pad_h_ = 0u;
  clear_has_pad_h();
}
inline ::google::protobuf::uint32 LSTMConvolutionParameter::pad_h() const {
  // @@protoc_insertion_point(field_get:caffe.LSTMConvolutionParameter.pad_h)
  return pad_h_;
}
inline void LSTMConvolutionParameter::set_pad_h(::google::protobuf::uint32 value) {
  set_has_pad_h();
  pad_h_ = value;
  // @@protoc_insertion_point(field_set:caffe.LSTMConvolutionParameter.pad_h)
}

// optional uint32 pad_w = 10 [default = 0];
inline bool LSTMConvolutionParameter::has_pad_w() const {
  return (_has_bits_[0] & 0x00000080u) != 0;
}
inline void LSTMConvolutionParameter::set_has_pad_w() {
  _has_bits_[0] |= 0x00000080u;
}
inline void LSTMConvolutionParameter::clear_has_pad_w() {
  _has_bits_[0] &= ~0x00000080u;
}
inline void LSTMConvolutionParameter::clear_pad_w() {
  pad_w_ = 0u;
  clear_has_pad_w();
}
inline ::google::protobuf::uint32 LSTMConvolutionParameter::pad_w() const {
  // @@protoc_insertion_point(field_get:caffe.LSTMConvolutionParameter.pad_w)
  return pad_w_;
}
inline void LSTMConvolutionParameter::set_pad_w(::google::protobuf::uint32 value) {
  set_has_pad_w();
  pad_w_ = value;
  // @@protoc_insertion_point(field_set:caffe.LSTMConvolutionParameter.pad_w)
}

// optional uint32 kernel_h = 11;
inline bool LSTMConvolutionParameter::has_kernel_h() const {
  return (_has_bits_[0] & 0x00000100u) != 0;
}
inline void LSTMConvolutionParameter::set_has_kernel_h() {
  _has_bits_[0] |= 0x00000100u;
}
inline void LSTMConvolutionParameter::clear_has_kernel_h() {
  _has_bits_[0] &= ~0x00000100u;
}
inline void LSTMConvolutionParameter::clear_kernel_h() {
  kernel_h_ = 0u;
  clear_has_kernel_h();
}
inline ::google::protobuf::uint32 LSTMConvolutionParameter::kernel_h() const {
  // @@protoc_insertion_point(field_get:caffe.LSTMConvolutionParameter.kernel_h)
  return kernel_h_;
}
inline void LSTMConvolutionParameter::set_kernel_h(::google::protobuf::uint32 value) {
  set_has_kernel_h();
  kernel_h_ = value;
  // @@protoc_insertion_point(field_set:caffe.LSTMConvolutionParameter.kernel_h)
}

// optional uint32 kernel_w = 12;
inline bool LSTMConvolutionParameter::has_kernel_w() const {
  return (_has_bits_[0] & 0x00000200u) != 0;
}
inline void LSTMConvolutionParameter::set_has_kernel_w() {
  _has_bits_[0] |= 0x00000200u;
}
inline void LSTMConvolutionParameter::clear_has_kernel_w() {
  _has_bits_[0] &= ~0x00000200u;
}
inline void LSTMConvolutionParameter::clear_kernel_w() {
  kernel_w_ = 0u;
  clear_has_kernel_w();
}
inline ::google::protobuf::uint32 LSTMConvolutionParameter::kernel_w() const {
  // @@protoc_insertion_point(field_get:caffe.LSTMConvolutionParameter.kernel_w)
  return kernel_w_;
}
inline void LSTMConvolutionParameter::set_kernel_w(::google::protobuf::uint32 value) {
  set_has_kernel_w();
  kernel_w_ = value;
  // @@protoc_insertion_point(field_set:caffe.LSTMConvolutionParameter.kernel_w)
}

// optional uint32 stride_h = 13;
inline bool LSTMConvolutionParameter::has_stride_h() const {
  return (_has_bits_[0] & 0x00000400u) != 0;
}
inline void LSTMConvolutionParameter::set_has_stride_h() {
  _has_bits_[0] |= 0x00000400u;
}
inline void LSTMConvolutionParameter::clear_has_stride_h() {
  _has_bits_[0] &= ~0x00000400u;
}
inline void LSTMConvolutionParameter::clear_stride_h() {
  stride_h_ = 0u;
  clear_has_stride_h();
}
inline ::google::protobuf::uint32 LSTMConvolutionParameter::stride_h() const {
  // @@protoc_insertion_point(field_get:caffe.LSTMConvolutionParameter.stride_h)
  return stride_h_;
}
inline void LSTMConvolutionParameter::set_stride_h(::google::protobuf::uint32 value) {
  set_has_stride_h();
  stride_h_ = value;
  // @@protoc_insertion_point(field_set:caffe.LSTMConvolutionParameter.stride_h)
}

// optional uint32 stride_w = 14;
inline bool LSTMConvolutionParameter::has_stride_w() const {
  return (_has_bits_[0] & 0x00000800u) != 0;
}
inline void LSTMConvolutionParameter::set_has_stride_w() {
  _has_bits_[0] |= 0x00000800u;
}
inline void LSTMConvolutionParameter::clear_has_stride_w() {
  _has_bits_[0] &= ~0x00000800u;
}
inline void LSTMConvolutionParameter::clear_stride_w() {
  stride_w_ = 0u;
  clear_has_stride_w();
}
inline ::google::protobuf::uint32 LSTMConvolutionParameter::stride_w() const {
  // @@protoc_insertion_point(field_get:caffe.LSTMConvolutionParameter.stride_w)
  return stride_w_;
}
inline void LSTMConvolutionParameter::set_stride_w(::google::protobuf::uint32 value) {
  set_has_stride_w();
  stride_w_ = value;
  // @@protoc_insertion_point(field_set:caffe.LSTMConvolutionParameter.stride_w)
}

// optional uint32 group = 5 [default = 1];
inline bool LSTMConvolutionParameter::has_group() const {
  return (_has_bits_[0] & 0x00001000u) != 0;
}
inline void LSTMConvolutionParameter::set_has_group() {
  _has_bits_[0] |= 0x00001000u;
}
inline void LSTMConvolutionParameter::clear_has_group() {
  _has_bits_[0] &= ~0x00001000u;
}
inline void LSTMConvolutionParameter::clear_group() {
  group_ = 1u;
  clear_has_group();
}
inline ::google::protobuf::uint32 LSTMConvolutionParameter::group() const {
  // @@protoc_insertion_point(field_get:caffe.LSTMConvolutionParameter.group)
  return group_;
}
inline void LSTMConvolutionParameter::set_group(::google::protobuf::uint32 value) {
  set_has_group();
  group_ = value;
  // @@protoc_insertion_point(field_set:caffe.LSTMConvolutionParameter.group)
}

// optional .caffe.FillerParameter weight_filler = 7;
inline bool LSTMConvolutionParameter::has_weight_filler() const {
  return (_has_bits_[0] & 0x00002000u) != 0;
}
inline void LSTMConvolutionParameter::set_has_weight_filler() {
  _has_bits_[0] |= 0x00002000u;
}
inline void LSTMConvolutionParameter::clear_has_weight_filler() {
  _has_bits_[0] &= ~0x00002000u;
}
inline void LSTMConvolutionParameter::clear_weight_filler() {
  if (weight_filler_ != NULL) weight_filler_->::caffe::FillerParameter::Clear();
  clear_has_weight_filler();
}
inline const ::caffe::FillerParameter& LSTMConvolutionParameter::weight_filler() const {
  // @@protoc_insertion_point(field_get:caffe.LSTMConvolutionParameter.weight_filler)
  return weight_filler_ != NULL ? *weight_filler_ : *default_instance_->weight_filler_;
}
inline ::caffe::FillerParameter* LSTMConvolutionParameter::mutable_weight_filler() {
  set_has_weight_filler();
  if (weight_filler_ == NULL) weight_filler_ = new ::caffe::FillerParameter;
  // @@protoc_insertion_point(field_mutable:caffe.LSTMConvolutionParameter.weight_filler)
  return weight_filler_;
}
inline ::caffe::FillerParameter* LSTMConvolutionParameter::release_weight_filler() {
  clear_has_weight_filler();
  ::caffe::FillerParameter* temp = weight_filler_;
  weight_filler_ = NULL;
  return temp;
}
inline void LSTMConvolutionParameter::set_allocated_weight_filler(::caffe::FillerParameter* weight_filler) {
  delete weight_filler_;
  weight_filler_ = weight_filler;
  if (weight_filler) {
    set_has_weight_filler();
  ...
  // @@protoc_insertion_point(field_set_allocated:caffe.LSTMConvolutionParameter.weight_filler)
}

// optional .caffe.FillerParameter bias_filler = 8;
inline bool LSTMConvolutionParameter::has_bias_filler() const {
  return (_has_bits_[0] & 0x00004000u) != 0;
}
inline void LSTMConvolutionParameter::set_has_bias_filler() {
  _has_bits_[0] |= 0x00004000u;
}
inline void LSTMConvolutionParameter::clear_has_bias_filler() {
  _has_bits_[0] &= ~0x00004000u;
}
inline void LSTMConvolutionParameter::clear_bias_filler() {
  if (bias_filler_ != NULL) bias_filler_->::caffe::FillerParameter::Clear();
  clear_has_bias_filler();
}
inline const ::caffe::FillerParameter& LSTMConvolutionParameter::bias_filler() const {
  // @@protoc_insertion_point(field_get:caffe.LSTMConvolutionParameter.bias_filler)
  return bias_filler_ != NULL ? *bias_filler_ : *default_instance_->bias_filler_;
}
inline ::caffe::FillerParameter* LSTMConvolutionParameter::mutable_bias_filler() {
  set_has_bias_filler();
  if (bias_filler_ == NULL) bias_filler_ = new ::caffe::FillerParameter;
  // @@protoc_insertion_point(field_mutable:caffe.LSTMConvolutionParameter.bias_filler)
  return bias_filler_;
}
inline ::caffe::FillerParameter* LSTMConvolutionParameter::release_bias_filler() {
  clear_has_bias_filler();
  ::caffe::FillerParameter* temp = bias_filler_;
  bias_filler_ = NULL;
  return temp;
}
inline void LSTMConvolutionParameter::set_allocated_bias_filler(::caffe::FillerParameter* bias_filler) {
  delete bias_filler_;
  bias_filler_ = bias_filler;
  if (bias_filler) {
    set_has_bias_filler();
  ...
  // @@protoc_insertion_point(field_set_allocated:caffe.LSTMConvolutionParameter.bias_filler)
}

// optional .caffe.LSTMConvolutionParameter.Engine engine = 15 [default = DEFAULT];
inline bool LSTMConvolutionParameter::has_engine() const {
  return (_has_bits_[0] & 0x00008000u) != 0;
}
inline void LSTMConvolutionParameter::set_has_engine() {
  _has_bits_[0] |= 0x00008000u;
}
inline void LSTMConvolutionParameter::clear_has_engine() {
  _has_bits_[0] &= ~0x00008000u;
}
inline void LSTMConvolutionParameter::clear_engine() {
  engine_ = 0;
  clear_has_engine();
}
inline ::caffe::LSTMConvolutionParameter_Engine LSTMConvolutionParameter::engine() const {
  // @@protoc_insertion_point(field_get:caffe.LSTMConvolutionParameter.engine)
  return static_cast< ::caffe::LSTMConvolutionParameter_Engine >(engine_);
}
inline void LSTMConvolutionParameter::set_engine(::caffe::LSTMConvolutionParameter_Engine value) {
  assert(::caffe::LSTMConvolutionParameter_Engine_IsValid(value));
  set_has_engine();
  engine_ = value;
  // @@protoc_insertion_point(field_set:caffe.LSTMConvolutionParameter.engine)
}

// optional int32 axis = 16 [default = 1];
inline bool LSTMConvolutionParameter::has_axis() const {
  return (_has_bits_[0] & 0x00010000u) != 0;
}
inline void LSTMConvolutionParameter::set_has_axis() {
  _has_bits_[0] |= 0x00010000u;
}
inline void LSTMConvolutionParameter::clear_has_axis() {
  _has_bits_[0] &= ~0x00010000u;
}
inline void LSTMConvolutionParameter::clear_axis() {
  axis_ = 1;
  clear_has_axis();
}
inline ::google::protobuf::int32 LSTMConvolutionParameter::axis() const {
  // @@protoc_insertion_point(field_get:caffe.LSTMConvolutionParameter.axis)
  return axis_;
}
inline void LSTMConvolutionParameter::set_axis(::google::protobuf::int32 value) {
  set_has_axis();
  axis_ = value;
  // @@protoc_insertion_point(field_set:caffe.LSTMConvolutionParameter.axis)
}

// optional bool force_nd_im2col = 17 [default = false];
inline bool LSTMConvolutionParameter::has_force_nd_im2col() const {
  return (_has_bits_[0] & 0x00020000u) != 0;
}
inline void LSTMConvolutionParameter::set_has_force_nd_im2col() {
  _has_bits_[0] |= 0x00020000u;
}
inline void LSTMConvolutionParameter::clear_has_force_nd_im2col() {
  _has_bits_[0] &= ~0x00020000u;
}
inline void LSTMConvolutionParameter::clear_force_nd_im2col() {
  force_nd_im2col_ = false;
  clear_has_force_nd_im2col();
}
inline bool LSTMConvolutionParameter::force_nd_im2col() const {
  // @@protoc_insertion_point(field_get:caffe.LSTMConvolutionParameter.force_nd_im2col)
  return force_nd_im2col_;
}
inline void LSTMConvolutionParameter::set_force_nd_im2col(bool value) {
  set_has_force_nd_im2col();
  force_nd_im2col_ = value;
  // @@protoc_insertion_point(field_set:caffe.LSTMConvolutionParameter.force_nd_im2col)
}

// optional string type = 19 [default = "all"];
inline bool LSTMConvolutionParameter::has_type() const {
  return (_has_bits_[0] & 0x00040000u) != 0;
}
inline void LSTMConvolutionParameter::set_has_type() {
  _has_bits_[0] |= 0x00040000u;
}
inline void LSTMConvolutionParameter::clear_has_type() {
  _has_bits_[0] &= ~0x00040000u;
}
inline void LSTMConvolutionParameter::clear_type() {
  if (type_ != _default_type_) {
    type_->assign(*_default_type_);
  }
  clear_has_type();
}
inline const ::std::string& LSTMConvolutionParameter::type() const {
  // @@protoc_insertion_point(field_get:caffe.LSTMConvolutionParameter.type)
  return *type_;
}
inline void LSTMConvolutionParameter::set_type(const ::std::string& value) {
  set_has_type();
  if (type_ == _default_type_) {
    type_ = new ::std::string;
  }
  type_->assign(value);
  // @@protoc_insertion_point(field_set:caffe.LSTMConvolutionParameter.type)
}
inline void LSTMConvolutionParameter::set_type(const char* value) {
  set_has_type();
  if (type_ == _default_type_) {
    type_ = new ::std::string;
  }
  type_->assign(value);
  // @@protoc_insertion_point(field_set_char:caffe.LSTMConvolutionParameter.type)
}
inline void LSTMConvolutionParameter::set_type(const char* value, size_t size) {
  set_has_type();
  if (type_ == _default_type_) {
    type_ = new ::std::string;
  }
  type_->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:caffe.LSTMConvolutionParameter.type)
}
inline ::std::string* LSTMConvolutionParameter::mutable_type() {
  set_has_type();
  if (type_ == _default_type_) {
    type_ = new ::std::string(*_default_type_);
  }
  // @@protoc_insertion_point(field_mutable:caffe.LSTMConvolutionParameter.type)
  return type_;
}
inline ::std::string* LSTMConvolutionParameter::release_type() {
  clear_has_type();
  if (type_ == _default_type_) {
    return NULL;
  } else {
...
inline void LSTMConvolutionParameter::set_allocated_type(::std::string* type) {
  if (type_ != _default_type_) {
    delete type_;
  }
  if (type) {
  ...
  // @@protoc_insertion_point(field_set_allocated:caffe.LSTMConvolutionParameter.type)
}
...
template <> struct is_proto_enum< ::caffe::LSTMConvolutionParameter_Engine> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::caffe::LSTMConvolutionParameter_Engine>() {
  return ::caffe::LSTMConvolutionParameter_Engine_descriptor();
}
