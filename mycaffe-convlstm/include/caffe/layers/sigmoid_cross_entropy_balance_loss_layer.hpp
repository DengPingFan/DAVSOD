#ifndef CAFFE_SIGMOID_CROSS_ENTROPY_BALANCE_LOSS_LAYER_HPP_
#define CAFFE_SIGMOID_CROSS_ENTROPY_BALANCE_LOSS_LAYER_HPP_
...
class SigmoidCrossEntropyBalanceLossLayer : public LossLayer<Dtype> {
 public:
  explicit SigmoidCrossEntropyBalanceLossLayer(const LayerParameter& param)
  ...
  virtual inline const char* type() const { return "SigmoidCrossEntropyBalanceLoss"; }

 protected:
  /// @copydoc SigmoidCrossEntropyBalanceLossLayer
...
#endif  // CAFFE_SIGMOID_CROSS_ENTROPY_BALANCE_LOSS_LAYER_HPP_
